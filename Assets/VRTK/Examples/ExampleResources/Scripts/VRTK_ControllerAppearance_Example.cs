namespace VRTK.Examples
{
    ...
    public class VRTK_ControllerAppearance_Example : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_ControllerAppearance_Example", "VRTK_ControllerEvents", "the same" }));
                return;
            }
