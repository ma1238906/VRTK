namespace VRTK.Examples
{
    ...
    public class VRTK_ControllerEvents_ListenerExample : MonoBehaviour
    {
        private void Start()
        {
            ...
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_ControllerEvents_ListenerExample", "VRTK_ControllerEvents", "the same"}));
                return;
            }
