namespace VRTK.Examples
{
    ...
    public class VRTK_ControllerUIPointerEvents_ListenerExample : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_ControllerUIPointerEvents_ListenerExample", "VRTK_UIPointer", "the Controller Alias" }));
                return;
            }
