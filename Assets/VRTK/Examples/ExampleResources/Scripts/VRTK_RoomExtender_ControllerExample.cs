namespace VRTK.Examples
{
    ...
    public class VRTK_RoomExtender_ControllerExample : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_RoomExtender_ControllerExample", "VRTK_ControllerEvents", "the Controller Alias" }));
                return;
            }
            if (FindObjectOfType<VRTK_RoomExtender>() == null)
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_SCENE", new string[] { "VRTK_RoomExtender_ControllerExample", "VRTK_RoomExtender" }));
                return;
            }
