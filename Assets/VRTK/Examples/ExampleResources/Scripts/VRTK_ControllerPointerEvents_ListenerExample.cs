namespace VRTK.Examples
{
    ...
    public class VRTK_ControllerPointerEvents_ListenerExample : MonoBehaviour
    {
        private void Start()
        {
            ...
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_ControllerPointerEvents_ListenerExample", "VRTK_DestinationMarker", "the Controller Alias" }));
                return;
            }
