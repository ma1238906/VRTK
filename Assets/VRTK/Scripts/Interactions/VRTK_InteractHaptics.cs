...
namespace VRTK
{
    ...
    public class VRTK_InteractHaptics : MonoBehaviour
    {
        ...
        protected virtual void OnEnable()
        {
            ...
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_InteractHaptics", "VRTK_InteractableObject", "the same" }));
            }
        }
