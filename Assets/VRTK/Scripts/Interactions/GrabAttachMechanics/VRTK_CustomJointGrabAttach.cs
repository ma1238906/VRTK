...
namespace VRTK.GrabAttachMechanics
{
    ...
    public class VRTK_CustomJointGrabAttach : VRTK_BaseJointGrabAttach
    {
        ...
        protected override void CreateJoint(GameObject obj)
        {
            if (!jointHolder)
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_NOT_INJECTED", new string[] { "VRTK_CustomJointGrabAttach", "Joint", "customJoint", "the same" }));
                return;
            }
