...
namespace VRTK
{
    ...
    public class VRTK_InteractControllerAppearance : MonoBehaviour
    {
        ...
        protected virtual void OnEnable()
        {
            ...
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_InteractControllerAppearance", "VRTK_InteractableObject", "the same" }));
            }
        }
