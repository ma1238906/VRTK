...
namespace VRTK.Highlighters
{
    ...
    public class VRTK_OutlineObjectCopyHighlighter : VRTK_BaseHighlighter
    {
        ...
        protected virtual GameObject CreateHighlightModel(GameObject givenOutlineModel, string givenOutlineModelPath)
        {
            ...
            if (copyModel == null)
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_OutlineObjectCopyHighlighter", "Renderer", "the same or child", " to add the highlighter to" }));
                return null;
            }
