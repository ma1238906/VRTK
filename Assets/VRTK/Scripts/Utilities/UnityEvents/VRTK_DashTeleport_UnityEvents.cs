namespace VRTK.UnityEventHelper
{
    ...
    public class VRTK_DashTeleport_UnityEvents : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (dt == null)
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_DashTeleport_UnityEvents", "VRTK_DashTeleport", "the same" }));
                return;
            }
