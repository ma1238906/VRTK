namespace VRTK.UnityEventHelper
{
    ...
    public class VRTK_HeadsetFade_UnityEvents : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (hf == null)
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_HeadsetFade_UnityEvents", "VRTK_HeadsetFade", "the same" }));
                return;
            }
