namespace VRTK.UnityEventHelper
{
    ...
    public class VRTK_BasicTeleport_UnityEvents : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (bt == null)
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_BasicTeleport_UnityEvents", "VRTK_BasicTeleport", "the same" }));
                return;
            }
