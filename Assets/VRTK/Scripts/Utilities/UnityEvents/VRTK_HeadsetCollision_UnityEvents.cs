namespace VRTK.UnityEventHelper
{
    ...
    public class VRTK_HeadsetCollision_UnityEvents : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (hc == null)
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_HeadsetCollision_UnityEvents", "VRTK_HeadsetCollision", "the same" }));
                return;
            }
