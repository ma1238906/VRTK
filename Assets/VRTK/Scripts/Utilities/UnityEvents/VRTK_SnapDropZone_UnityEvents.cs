namespace VRTK.UnityEventHelper
{
    ...
    public class VRTK_SnapDropZone_UnityEvents : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (sdz == null)
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_SnapDropZone_UnityEvents", "VRTK_SnapDropZone", "the same" }));
                return;
            }
