namespace VRTK.UnityEventHelper
{
    ...
    public class VRTK_HeadsetControllerAware_UnityEvents : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (hca == null)
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_HeadsetControllerAware_UnityEvents", "VRTK_HeadsetControllerAware", "the same" }));
                return;
            }
