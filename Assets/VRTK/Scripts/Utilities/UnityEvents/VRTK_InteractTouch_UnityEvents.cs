namespace VRTK.UnityEventHelper
{
    ...
    public class VRTK_InteractTouch_UnityEvents : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (it == null)
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_InteractTouch_UnityEvents", "VRTK_InteractTouch", "the same" }));
                return;
            }
