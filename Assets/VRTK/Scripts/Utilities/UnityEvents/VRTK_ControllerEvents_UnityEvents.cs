namespace VRTK.UnityEventHelper
{
    ...
    public class VRTK_ControllerEvents_UnityEvents : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (ce == null)
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_ControllerEvents_UnityEvents", "VRTK_ControllerEvents", "the same" }));
                return;
            }
