namespace VRTK.UnityEventHelper
{
    ...
    public class VRTK_InteractUse_UnityEvents : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (iu == null)
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_InteractUse_UnityEvents", "VRTK_InteractUse", "the same" }));
                return;
            }
