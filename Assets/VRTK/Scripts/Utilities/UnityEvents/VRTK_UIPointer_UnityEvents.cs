namespace VRTK.UnityEventHelper
{
    ...
    public class VRTK_UIPointer_UnityEvents : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (uip == null)
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_UIPointer_UnityEvents", "VRTK_UIPointer", "the same" }));
                return;
            }
