namespace VRTK.UnityEventHelper
{
    ...
    public class VRTK_DestinationMarker_UnityEvents : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (dm == null)
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_DestinationMarker_UnityEvents", "VRTK_DestinationMarker", "the same" }));
                return;
            }
