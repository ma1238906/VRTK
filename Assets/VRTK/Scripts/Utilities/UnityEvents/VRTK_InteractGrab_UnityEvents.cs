namespace VRTK.UnityEventHelper
{
    ...
    public class VRTK_InteractGrab_UnityEvents : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (ig == null)
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_InteractGrab_UnityEvents", "VRTK_InteractGrab", "the same" }));
                return;
            }
