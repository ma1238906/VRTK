namespace VRTK.UnityEventHelper
{
    ...
    public class VRTK_ObjectControl_UnityEvents : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (oc == null)
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_ObjectControl_UnityEvents", "VRTK_ObjectControl", "the same" }));
                return;
            }
