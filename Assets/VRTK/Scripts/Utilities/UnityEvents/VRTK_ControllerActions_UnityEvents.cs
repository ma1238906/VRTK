namespace VRTK.UnityEventHelper
{
    ...
    public class VRTK_ControllerActions_UnityEvents : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (ca == null)
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_ControllerActions_UnityEvents", "VRTK_ControllerActions", "the same" }));
                return;
            }
