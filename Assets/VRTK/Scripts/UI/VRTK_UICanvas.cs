...
namespace VRTK
{
    ...
    public class VRTK_UICanvas : MonoBehaviour
    {
        ...
        protected virtual void SetupCanvas()
        {
            ...
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_UICanvas", "Canvas", "the same", " that is set to `Render Mode = World Space`" }));
                return;
            }
