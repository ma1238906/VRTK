...
namespace VRTK
{
    ...
    public class VRTK_UIDraggableItem : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        ...
        protected virtual void OnEnable()
        {
            ...
            {
                enabled = false;
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_UIDraggableItem", "VRTK_UIDropZone", "the parent", " if `freeDrop = false`" }));
            }
        }
