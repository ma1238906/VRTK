...
namespace VRTK
{
    ...
    public abstract class VRTK_ObjectControl : MonoBehaviour
    {
        ...
        protected virtual void OnEnable()
        {
            ...
            if (!controllerEvents)
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_NOT_INJECTED", new string[] { "VRTK_ObjectControl", "VRTK_ControllerEvents", "controller", "the same" }));
                return;
            }
            SetControlledObject();
