namespace VRTK
{
    ...
    public class VRTK_RoomExtender_PlayAreaGizmo : MonoBehaviour
    {
        ...
        protected virtual void Awake()
        {
            ...
            {
                VRTK_Logger.Warn(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_RoomExtender_PlayAreaGizmo", "PlayArea or VRTK_RoomExtender", "an active" }));
                return;
            }
        }
