...
namespace VRTK
{
    ...
    public class VRTK_IndependentRadialMenuController : RadialMenuController
    {
        ...
        public virtual void UpdateEventsManager()
        {
            ...
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_NOT_INJECTED", new string[] { "VRTK_IndependentRadialMenuController", "VRTK_InteractableObject", "eventsManager", "the parent" }));
                return;
            }
        ...
        protected virtual void Update()
        {
            if (rotateTowards == null) // Backup
            {
                ...
                {
                    VRTK_Logger.Warn(VRTK_Logger.GetCommonMessage("COULD_NOT_FIND_OBJECT_FOR_ACTION", new string[] { "IndependentRadialMenu", "an object", "rotate towards" }));
                }
            }
