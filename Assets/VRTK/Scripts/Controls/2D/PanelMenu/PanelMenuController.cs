...
namespace VRTK
{
    ...
    public class PanelMenuController : MonoBehaviour
    {
        ...
        protected virtual void Start()
        {
            ...
            {
                VRTK_Logger.Warn(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "PanelMenuController", "VRTK_InteractableObject", "a parent" }));
                return;
            }
            ...
            {
                VRTK_Logger.Warn(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "PanelMenuController", "Canvas", "a child" }));
            }
        }
        ...
        protected virtual void Update()
        {
            if (interactableObject != null)
            {
                if (rotateTowards == null)
                {
                    ...
                    if (rotateTowards == null)
                    {
                        VRTK_Logger.Warn(VRTK_Logger.GetCommonMessage("COULD_NOT_FIND_OBJECT_FOR_ACTION", new string[] { "PanelMenuController", "an object", "rotate towards"}));
                    }
                }
