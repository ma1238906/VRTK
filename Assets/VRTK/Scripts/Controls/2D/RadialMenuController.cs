namespace VRTK
{
    ...
    public class RadialMenuController : MonoBehaviour
    {
        ...
        protected virtual void OnEnable()
        {
            if (events == null)
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_NOT_INJECTED", new string[] { "RadialMenuController", "VRTK_ControllerEvents", "events", "the parent" }));
                return;
            }
            else
            {
