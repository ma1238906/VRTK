...
namespace VRTK
{
    ...
    public class VRTK_Pointer : VRTK_DestinationMarker
    {
        ...
        protected override void OnEnable()
        {
            ...
            {
                VRTK_Logger.Warn(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_PARAMETER", new string[] { "VRTK_Pointer", "VRTK_BasePointerRenderer", "Pointer Renderer" }));
            }
            if (activateOnEnable)
            {
                Toggle(true);
        ...
        protected virtual void FindController()
        {
            ...
            {
                VRTK_Logger.Warn(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_FROM_GAMEOBJECT", new string[] { "VRTK_Pointer", "VRTK_ControllerEvents", "the Controller Alias", ". To omit this warning, set the `Activation Button` and `Selection Button` to `Undefined`" }));
            }
