...
namespace VRTK
{
    ...
    public abstract class VRTK_BasePointer : VRTK_DestinationMarker
    {
        ...
        private void SetupController()
        {
            ...
            if (controller == null)
            {
                VRTK_Logger.Error(VRTK_Logger.GetCommonMessage("REQUIRED_COMPONENT_MISSING_NOT_INJECTED", new string[] { "VRTK_BasePointer", "VRTK_ControllerEvents", "controller", "the same" }));
            }
        }
